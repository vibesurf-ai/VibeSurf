...
from vibe_surf.agents.views import VibeSurfAgentOutput, VibeSurfAgentSettings
...
class VibeSurfAgent:
    ...
    def __init__(
            ...
            tools: VibeSurfController,
            settings: VibeSurfAgentSettings | None = None,
        ...
        # Token cost service
        self.token_cost_service = TokenCost(include_cost=self.settings.include_token_cost)
        ...
        logger.info("🌊 VibeSurf Agent initialized")
    ...
    def _setup_action_models(self):
        ...
        self.AgentOutput = VibeSurfAgentOutput.type_with_custom_actions(self.ActionModel)
...
"""
    ...
    async def _get_model_output_with_retry(self, input_messages: List[BaseMessage],
                                           model_output: VibeSurfAgentOutput) -> VibeSurfAgentOutput:
                ...
                if can_execute_in_parallel:
                    ...
                    for local_index, action in enumerate(action_group):
                        ...
                        try:
                            ...
                            if action_result.get("is_final", False) or action_result.get(
                                    "error") or i == total_actions - 1:
                                break
