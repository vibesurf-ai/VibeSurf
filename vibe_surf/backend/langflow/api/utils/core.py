...
from vibe_surf.backend.langflow.services.auth.utils import get_current_active_user, get_current_active_user_mcp
from vibe_surf.backend.langflow.services.database.models.flow.model import Flow
from vibe_surf.backend.langflow.services.database.models.message.model import MessageTable
...
from vibe_surf.backend.langflow.services.deps import get_session, session_scope
from vibe_surf.backend.langflow.services.store.utils import get_lf_version_from_pypi
from vibe_surf.backend.langflow.utils.constants import LANGFLOW_GLOBAL_VAR_HEADER_PREFIX

if TYPE_CHECKING:
    from vibe_surf.backend.langflow.services.chat.service import ChatService
    from vibe_surf.backend.langflow.services.store.schema import StoreComponentCreate
...
async def verify_public_flow_and_get_user(flow_id: uuid.UUID, client_id: str | None) -> tuple[User, uuid.UUID]:
    ...
    async with session_scope() as session:
        ...
        from vibe_surf.backend.langflow.services.database.models.flow.model import AccessTypeEnum, Flow
    ...
    try:
        from vibe_surf.backend.langflow.helpers.user import get_user_by_flow_id_or_endpoint_name
