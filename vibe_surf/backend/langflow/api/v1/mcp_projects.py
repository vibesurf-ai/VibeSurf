...
from vibe_surf.backend.langflow.api.utils import CurrentActiveMCPUser, extract_global_variables_from_headers
from vibe_surf.backend.langflow.api.utils.mcp import auto_configure_starter_projects_mcp, get_project_sse_url, get_url_by_os
from vibe_surf.backend.langflow.api.v1.auth_helpers import handle_auth_settings_update
from vibe_surf.backend.langflow.api.v1.mcp_utils import (
...
from vibe_surf.backend.langflow.services.auth.mcp_encryption import decrypt_auth_settings, encrypt_auth_settings
from vibe_surf.backend.langflow.services.auth.utils import AUTO_LOGIN_WARNING
from vibe_surf.backend.langflow.services.database.models import Flow, Folder
from vibe_surf.backend.langflow.services.database.models.api_key.crud import check_key, create_api_key
from vibe_surf.backend.langflow.services.database.models.api_key.model import ApiKey, ApiKeyCreate
from vibe_surf.backend.langflow.services.database.models.user.crud import get_user_by_username
from vibe_surf.backend.langflow.services.database.models.user.model import User
from vibe_surf.backend.langflow.services.deps import get_service
...
async def verify_project_auth_conditional(
    ...
    async with session_scope() as session:
        ...
        from vibe_surf.backend.langflow.services.auth.utils import get_current_user_mcp
