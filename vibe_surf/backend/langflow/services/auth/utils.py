...
from vibe_surf.backend.langflow.services.database.models.api_key.crud import check_key
from vibe_surf.backend.langflow.services.database.models.user.crud import get_user_by_id, get_user_by_username, update_user_last_login_at
from vibe_surf.backend.langflow.services.database.models.user.model import User, UserRead
from vibe_surf.backend.langflow.services.deps import get_db_service, get_session, get_settings_service, session_scope

if TYPE_CHECKING:
    from vibe_surf.backend.langflow.services.database.models.api_key.model import ApiKey
...
async def create_user_longterm_token(db: AsyncSession) -> tuple[UUID, dict]:
    ...
    super_user = await get_user_by_username(db, username)
    if not super_user:
        from vibe_surf.backend.langflow.services.database.models.user.crud import get_all_superusers
