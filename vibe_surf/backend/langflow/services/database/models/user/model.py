...
from vibe_surf.backend.langflow.schema.serialize import UUIDstr
...
if TYPE_CHECKING:
    ...
    from vibe_surf.backend.langflow.services.database.models.variable.model import Variable
