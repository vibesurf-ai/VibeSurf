...
from vibe_surf.backend.langflow.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
...
from vibe_surf.backend.langflow.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.vibe_surf.backend.langflow.store/store/" in search_string:
