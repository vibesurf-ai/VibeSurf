...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("vibe_surf.backend.langflow.project.name", self.project_name)
            self.root_span.set_attribute("vibe_surf.backend.langflow.flow.name", self.flow_name)
            self.root_span.set_attribute("vibe_surf.backend.langflow.flow.id", self.flow_id)
