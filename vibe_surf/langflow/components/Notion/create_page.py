...
from vibe_surf.langflow.inputs.inputs import MultilineInput, SecretStrInput, StrInput
...
class NotionPageCreator(LCToolComponent):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/integrations/notion/page-create"
