...
from vibe_surf.langflow.inputs.inputs import SecretStrInput, StrInput
...
class NotionDatabaseProperties(LCToolComponent):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/integrations/notion/list-database-properties"
