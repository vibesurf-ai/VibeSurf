...
from vibe_surf.langflow.inputs.inputs import DropdownInput, SecretStrInput, StrInput
...
class NotionSearch(LCToolComponent):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/integrations/notion/search"
