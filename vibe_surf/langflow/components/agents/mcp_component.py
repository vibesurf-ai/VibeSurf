...
from vibe_surf.langflow.api.v2.mcp import get_server
from vibe_surf.langflow.base.agents.utils import maybe_unflatten_dict, safe_cache_get, safe_cache_set
from vibe_surf.langflow.base.mcp.util import (
    MCPSseClient,
    MCPStdioClient,
    create_input_schema_from_json_schema,
    update_tools,
)
from vibe_surf.langflow.custom.custom_component.component_with_cache import ComponentWithCache
from vibe_surf.langflow.inputs.inputs import InputTypes  # noqa: TC001
from vibe_surf.langflow.io import DropdownInput, McpInput, MessageTextInput, Output
from vibe_surf.langflow.io.schema import flatten_schema, schema_to_langflow_inputs
from vibe_surf.langflow.logging import logger
from vibe_surf.langflow.schema.dataframe import DataFrame
from vibe_surf.langflow.schema.message import Message

# Import get_server from the backend API
from vibe_surf.langflow.services.database.models.user.crud import get_user_by_id
from vibe_surf.langflow.services.deps import get_settings_service, get_storage_service, session_scope
...
class MCPToolsComponent(ComponentWithCache):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/mcp-client"
    icon = "Mcp"
    name = "MCPTools"
