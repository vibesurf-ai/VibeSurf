...
from vibe_surf.langflow.inputs.inputs import BoolInput, DictInput, FloatInput
    ...
    def search_documents(self) -> list[Data]:
        ...
        if self.search_query and isinstance(self.search_query, str) and self.search_query.strip():
            try:
                ...
                if "content" in str(e):
                    msg = (
                        "You should ingest data through Langflow (or LangChain) to query it in vibe_surf.langflow. "
