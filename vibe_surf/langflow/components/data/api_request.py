...
from vibe_surf.langflow.base.curl.parse import parse_context
from vibe_surf.langflow.custom.custom_component.component import Component
from vibe_surf.langflow.inputs.inputs import TabInput
...
from vibe_surf.langflow.utils.component_utils import set_current_fields, set_field_advanced, set_field_display
...
class APIRequestComponent(Component):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/components-data#api-request"
    icon = "Globe"
    name = "APIRequest"
