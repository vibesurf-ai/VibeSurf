...
from vibe_surf.langflow.io import IntInput, MessageTextInput, Output
from vibe_surf.langflow.schema import DataFrame
...
class NewsSearchComponent(Component):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/components-data#news-search"
    icon = "newspaper"
    name = "NewsSearch"
