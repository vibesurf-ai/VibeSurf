...
from vibe_surf.langflow.io import BoolInput, MessageTextInput, MultilineInput, Output
...
class SQLComponent(ComponentWithCache):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/components-data#sql-database"
    icon = "database"
    name = "SQLComponent"
