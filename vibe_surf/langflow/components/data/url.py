...
from vibe_surf.langflow.io import BoolInput, DropdownInput, IntInput, MessageTextInput, Output, SliderInput, TableInput
...
class URLComponent(Component):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/components-data#url"
