...
from vibe_surf.langflow.io import DictInput, IntInput, SecretStrInput, StrInput, TableInput
...
class AstraDBCQLToolComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/Components/components-tools#astra-db-cql-tool"
    icon: str = "AstraDB"
