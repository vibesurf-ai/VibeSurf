...
from vibe_surf.langflow.io import HandleInput, StrInput
from vibe_surf.langflow.services.database.models.base import orjson_dumps
...
class JSONDocumentBuilder(CustomComponent):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/components/utilities#json-document-builder"
    legacy = True
