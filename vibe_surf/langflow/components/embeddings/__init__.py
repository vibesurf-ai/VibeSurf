...
if TYPE_CHECKING:
    from vibe_surf.langflow.components.embeddings.similarity import EmbeddingSimilarityComponent
    from vibe_surf.langflow.components.embeddings.text_embedder import TextEmbedderComponent
