...
from vibe_surf.langflow.base.langchain_utilities.model import LCToolComponent
from vibe_surf.langflow.field_typing import Tool
from vibe_surf.langflow.inputs.inputs import IntInput, MultilineInput, NestedDictInput, SecretStrInput, StrInput
...
class GleanSearchAPIComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/Components/components-tools#glean-search-api"
    icon: str = "Glean"
