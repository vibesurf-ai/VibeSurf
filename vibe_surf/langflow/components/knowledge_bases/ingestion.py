...
from vibe_surf.langflow.base.knowledge_bases.knowledge_base_utils import get_knowledge_bases
from vibe_surf.langflow.base.models.openai_constants import OPENAI_EMBEDDING_MODEL_NAMES
from vibe_surf.langflow.components.processing.converter import convert_to_dataframe
...
from vibe_surf.langflow.schema.dotdict import dotdict  # noqa: TC001
from vibe_surf.langflow.schema.table import EditMode
from vibe_surf.langflow.services.auth.utils import decrypt_api_key, encrypt_api_key
...
class KnowledgeIngestionComponent(Component):
    ...
    description = "Create or update knowledge in vibe_surf.langflow."
    icon = "upload"
            ...
            default_factory=lambda: {
                "data": {
                    "node": {
                        ...
                        "description": "Create new knowledge in vibe_surf.langflow.",
