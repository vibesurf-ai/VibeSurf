...
if TYPE_CHECKING:
    from vibe_surf.langflow.components.lmstudio.lmstudioembeddings import LMStudioEmbeddingsComponent
    from vibe_surf.langflow.components.lmstudio.lmstudiomodel import LMStudioModelComponent
