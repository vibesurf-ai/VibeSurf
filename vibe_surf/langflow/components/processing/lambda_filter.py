...
from vibe_surf.langflow.io import DataInput, HandleInput, IntInput, MultilineInput, Output
from vibe_surf.langflow.schema.data import Data
from vibe_surf.langflow.utils.data_structure import get_data_structure
...
class LambdaFilterComponent(Component):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/components-processing#smart-function"
