...
from vibe_surf.langflow.inputs.inputs import BoolInput, HandleInput, MessageTextInput, MultilineInput, TabInput
...
class ParserComponent(Component):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/components-processing#parser"
    icon = "braces"
