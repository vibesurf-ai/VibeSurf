...
from vibe_surf.langflow.io import MultilineInput, Output, StrInput
...
class PythonREPLComponent(Component):
    ...
    documentation: str = "https://docs.vibe_surf.langflow.org/components-processing#python-interpreter"
