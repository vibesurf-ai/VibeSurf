...
from vibe_surf.langflow.base.vectorstores.model import LCVectorStoreComponent, check_cached_vector_store
from vibe_surf.langflow.base.vectorstores.utils import chroma_collection_to_data
from vibe_surf.langflow.inputs.inputs import MultilineInput
from vibe_surf.langflow.io import BoolInput, DropdownInput, HandleInput, IntInput, MessageTextInput, TabInput
...
class LocalDBComponent(LCVectorStoreComponent):
    ...
    def get_default_persist_dir(self) -> str:
        ...
        from vibe_surf.langflow.services.cache.utils import CACHE_DIR
