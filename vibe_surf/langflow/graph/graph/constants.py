...
from vibe_surf.langflow.graph.schema import CHAT_COMPONENTS
from vibe_surf.langflow.utils.lazy_load import LazyLoadDictBase

if TYPE_CHECKING:
    from vibe_surf.langflow.graph.vertex.base import Vertex
    from vibe_surf.langflow.graph.vertex.vertex_types import CustomComponentVertex
...
def _import_vertex_types():
    from vibe_surf.langflow.graph.vertex import vertex_types
