...
from vibe_surf.langflow.utils.constants import MESSAGE_SENDER_AI, MESSAGE_SENDER_USER
...
class Data(BaseModel):
    ...
    def to_lc_message(
        ...
        if sender == MESSAGE_SENDER_USER:
            if files:
                from vibe_surf.langflow.schema.image import get_file_paths
    ...
    def filter_data(self, filter_str: str) -> Data:
        ...
        """
        from vibe_surf.langflow.template.utils import apply_json_filter

        return apply_json_filter(self.data, filter_str)

    def to_message(self) -> Message:
        from vibe_surf.langflow.schema.message import Message  # Local import to avoid circular import
