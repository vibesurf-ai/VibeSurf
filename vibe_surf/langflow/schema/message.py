...
from vibe_surf.langflow.base.prompts.utils import dict_values_to_string
from vibe_surf.langflow.logging.logger import logger
from vibe_surf.langflow.schema.content_block import ContentBlock
from vibe_surf.langflow.schema.content_types import ErrorContent
from vibe_surf.langflow.schema.data import Data
from vibe_surf.langflow.schema.image import Image, get_file_paths, is_image_file
from vibe_surf.langflow.schema.properties import Properties, Source
from vibe_surf.langflow.schema.validators import timestamp_to_str, timestamp_to_str_validator
...
from vibe_surf.langflow.utils.image import create_image_content_dict
...
class Message(Data):
    ...
    def to_dataframe(self) -> DataFrame:
        from vibe_surf.langflow.schema.dataframe import DataFrame  # Local import to avoid circular import
