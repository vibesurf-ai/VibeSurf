...
from vibe_surf.langflow.services.store.exceptions import APIKeyError, FilterError, ForbiddenError
...
from vibe_surf.langflow.services.store.utils import (
...
def get_id_from_search_string(search_string: str) -> str | None:
    ...
    if "www.vibe_surf.langflow.store/store/" in search_string:
