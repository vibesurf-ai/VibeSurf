...
from vibe_surf.langflow.services.tracing.base import BaseTracer
...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("vibe_surf.langflow.project.name", self.project_name)
            self.root_span.set_attribute("vibe_surf.langflow.flow.name", self.flow_name)
            self.root_span.set_attribute("vibe_surf.langflow.flow.id", self.flow_id)
